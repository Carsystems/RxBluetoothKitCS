Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/Carsystems/RxBluetoothKitCS"
  ...
  s.source           = { :git => "https://github.com/Carsystems/RxBluetoothKitCS.git", :tag => s.version.to_s }
